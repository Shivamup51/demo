...
export default function HomePage() {
  ...
  const stats = [
    {
      icon: <Calendar className="w-8 h-8 sm:w-10 sm:h-10 text-[#6c2c8b]" />,
      value: "10+",
      label: "Years of Experience",
    },
    {
      icon: <Heart className="w-8 h-8 sm:w-10 sm:h-10 text-[#6c2c8b]" />,
      value: "10K",
      label: "Lives Transformed",
    },
    {
      icon: <Award className="w-8 h-8 sm:w-10 sm:h-10 text-[#6c2c8b]" />,
      value: "15+",
  ...
  const Services = [
    {
      name: "Dry Needling",
      desc: "Relieves muscle tension and triggers natural healing using targeted needle points",
      href: "/services/DryNeedling",
      icon: <Syringe className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Cupping Therapy",
      desc: "Boosts circulation and eases pain through gentle suction-based decompression technique",
      href: "/services/cupping-therapy",
      icon: <Waves className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Kinesio Taping",
      desc: "Supports injured areas and improves movement without restricting active mobility or flow",
      href: "/services/KinesioTapingTherapy",
      icon: <Bandage className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Laser Therapy",
      desc: "Promotes deep tissue recovery using focused light energy for pain relief and repair",
      href: "/services/LaserTherapy",
      icon: <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Manual Therapy",
      desc: "Hands-on techniques including myofascial release to improve mobility and reduce stiffness",
      href: "/services/ManualTherapy",
      icon: <Activity className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Electro Therapy",
      desc: "Stimulates healing with modalities like shockwave to treat chronic pain zones",
      href: "/services/Electrotherapy",
      icon: <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Sports Physiotherapy",
      desc: "Performance-based rehab for athletes recovering from injuries or movement imbalances",
      href: "/services/SportsPhysiotherapy",
      icon: <Dumbbell className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Pre & Post Natal Care",
      desc: "Specialized therapy to support women through pregnancy changes and recovery",
      href: "/services/PreAndPostNatalPhysiotherapy",
      icon: <Heart className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Cardio & Pulmonary Rehab",
      desc: "Restores endurance and lung capacity after illness, surgery or inactivity",
      href: "/services/CardioPulmonaryRehab",
      icon: <Heart className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Neuro Rehabilitation",
      desc: "Enhances mobility and control after stroke, nerve injury or neurological disorders",
      href: "/services/NeuroRehabilitation",
      icon: <Brain className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Chiropractic",
      desc: "Realigns spine and joints using precision adjustments to reduce pain and improve function",
      href: "/services/ChiropracticCare",
      icon: <Bone className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Geriatric Rehabilitation",
      desc: "Rebuilds strength, balance, and gait for safer movement in aging bodies",
      href: "/services/GeriatricRehabilitation",
      icon: <Accessibility className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Post Surgical Rehabilitation",
      desc: "Guided recovery plans to regain strength and prevent long-term complications",
      href: "/services/PostSurgicalRehabilitation",
      icon: <Thermometer className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
    {
      name: "Spine Alignment",
      desc: "Relieves body stiffness by correcting posture and improving spinal mechanics holistically",
      href: "/services/SpineAlignmentTherapy",
      icon: <Bone className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
    },
  ];
  ...
  const filteredConditions =
    activeConditionCategory === "All"
      ? conditions
      : conditions.filter(
          (condition) => condition.category === activeConditionCategory
        );
    ...
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
          ...
          >
            ...
            >
              ...
              <Link href="/home-visit" className="w-full sm:hidden">
                <Button className="bg-gradient-to-r from-[#6c2c8b] to-[#9d4ed8] text-white hover:opacity-90 px-6 py-4 text-sm font-medium rounded-xl shadow-lg w-full">
          ...
          {[
            {
              ...
              title: "Working Hours",
              lines: ["Monday to Saturday 08:00 AM - 08:00 PM"],
            },
            {
              icon: <Phone className="w-5 h-5 sm:w-6 sm:h-6 text-white " />,
              title: "Contact Us",
              lines: ["+91 8868879387", "info@kynexaphysio.com"],
            },
            {
              icon: <MapPin className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
              title: "Our Location",
              lines: ["D 16, Basement, Hauz Khas , New Delhi-110016"],
            },
          ].map((item, index) => (
            <motion.div
              key={index}
            ...
            >
              ...
              <div className="min-w-0">
                ...
                {item.lines.map((line, i) => (
                  <p key={i} className="text-xs sm:text-sm text-white truncate">
                    {line}
                  </p>
                ))}
              </div>
      ...
      >
        <div className="max-w-7xl mx-auto text-center w-full">
          <Badge className="bg-[#6c2c8b]/80 text-white border-none px-3 sm:px-4 py-1.5 mb-4 text-xs sm:text-sm">
            Your Progress, Our Promise
          </Badge>
          <h2 className="text-2xl sm:text-3xl font-bold text-[#6c2c8b] font-heading mb-4 sm:mb-6">
            Our Experience By The Numbers
          </h2>
          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto mb-8 sm:mb-12 px-4">
            Trust your health to our experienced team with a proven track record
      ...
      >
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-[#6c2c8b] font-heading">
              Why Choose Kynexa
            </h2>
            <p className="text-sm sm:text-lg text-gray-700 font-body mt-4 max-w-2xl mx-auto px-4">
              Care That Moves You – Advanced therapy, personalized plans, and
              ...
              <motion.div key={index} variants={fadeInUp}>
                <Card className="border-none rounded-xl shadow-md hover:shadow-lg transition-shadow overflow-hidden bg-[#6c2c8b]/80 h-full">
                  <CardContent className="p-4 sm:p-6 text-center flex flex-col h-full">
                    ...
                    <p className="text-white font-body text-sm sm:text-base flex-grow">
                      {item.desc}
                    </p>
                  </CardContent>
                </Card>
      ...
      <section className="py-12 sm:py-16 bg-[#f8f9fa] overflow-x-hidden">
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center mb-8 sm:mb-12 px-4 sm:px-6 lg:px-8">
            <Badge className="bg-[#f3eaf8] text-[#6c2c8b] border-none px-3 sm:px-4 py-1.5 mb-4 text-xs sm:text-sm">
              Specialized Care
            </Badge>
            <motion.h2
            ...
            <p className="text-sm sm:text-lg text-gray-700 font-body max-w-2xl mx-auto">
              Comprehensive therapeutic solutions delivered by experienced
          ...
          <div className="relative w-full group overflow-x-hidden">
            ...
            >
              {Services.map((service: any, index: number) => (
                <div
                  key={index}
                  className="flex-shrink-0 mx-2 sm:mx-3 w-[240px] sm:w-[280px]"
                >
                  <Link
                    href={service.href}
                  ...
                  >
                    <Card className="border-none rounded-xl shadow-md group-hover/card:shadow-lg transition-shadow overflow-hidden h-full bg-[#6c2c8b]/80">
                      <CardContent className="p-4 sm:p-6 flex flex-col h-full">
                        ...
                        <p className="text-white font-body text-sm sm:text-base flex-grow leading-relaxed">
                          {service.desc}
                        </p>
      ...
      >
        <div className="max-w-4xl mx-auto text-center space-y-4 sm:space-y-6 relative overflow-hidden w-full">
          ...
          ></motion.div>
          <Badge className="bg-white/20 text-white border-none px-3 sm:px-4 py-1.5 mb-4 text-xs sm:text-sm">
            Schedule Today
          </Badge>
          <motion.h2
          ...
          >
            Your path to healing starts with a single step—and we're here to
            walk it with you. Whether you're struggling with pain, planning your
            recovery, or just exploring options, Kynexa's team is standing by.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-[#6c2c8b] font-heading mb-4">
              What Our Patients Say
            </h2>
            <p className="text-sm sm:text-lg text-gray-700 max-w-2xl mx-auto px-4">
              Real stories from real patients who have experienced the Kynexa
              difference.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <Badge className="bg-[#f3eaf8] text-[#6c2c8b] border-none px-3 sm:px-4 py-1.5 text-xs sm:text-sm">
                Our Story
              </Badge>
              <h2 className="text-2xl sm:text-3xl font-bold text-[#6c2c8b] font-heading">
                About Kynexa
              ...
              <p className="text-sm sm:text-lg text-gray-700 font-body">
                ...
                believe healing is not just about recovery—it’s about
                rediscovering strength, restoring confidence, and reclaiming
                your life. Located in the heart of Delhi, our clinic offers a
                sanctuary for those seeking comprehensive, compassionate, and
                cutting-edge physiotherapy solutions. Whether you're navigating
                post-surgical rehabilitation, managing chronic pain, or
                recovering from sports injuries, our expert team combines
                advanced manual therapy with evidence-based techniques to create
                customized treatment plans tailored to your goals. With a strong
                emphasis on patient education, proactive care, and long-term
                wellness, we help you move better, feel stronger, and live
                pain-free , so you can return to the lifestyle you love with
                confidence and ease.
              </p>
              <motion.div
                whileHover={{ scale: 1.05 }}
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-lg text-gray-700 max-w-2xl mx-auto mb-6 sm:mb-8 px-4">
              Our Physiotherapists are experienced in treating a wide range of
              conditions.
            </p>
                ...
                >
                  <Card className="border-none rounded-xl shadow-sm hover:shadow-md transition-shadow bg-[#6c2c8b]/80 h-full">
                    <CardContent className="p-4 sm:p-5 flex items-center gap-3">
                      ...
                      <h3 className="text-sm sm:text-base font-medium text-white text-left flex-grow">
                        {condition.name}
                      </h3>
                    </CardContent>
                  </Card>

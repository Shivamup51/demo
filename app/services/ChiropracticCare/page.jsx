...
export default function ChiropracticCarePage() {
  ...
  const treatmentApproach = [
    ...
    },
    {
      ...
      description:
        "Myofascial or trigger point therapy to reduce muscular tension",
    ...
    },
    {
      ...
      description:
        "Breathing drills or relaxation cues to support pain relief and nervous system balance.",
      icon: <FaRegChartBar className="w-7 h-7" />,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes! When performed by trained professionals, chiropractic adjustments are safe, precise, and effective.",
    },
    {
      question: "Will I feel pain during adjustment?",
      answer:
        "Most patients feel relief. You may hear a gentle “pop” as gas is released from the joint, which is completely normal.",
    },
    {
      question: "How many sessions will I need?",
      answer:
        "It varies per person. Some feel improvement after 1–2 sessions, while others may benefit from a short course for lasting results.",
    },
    {
      question: "Can I receive chiropractic therapy alongside physiotherapy?",
      answer:
        "Absolutely. In fact, combining the two often leads to faster, more sustainable recovery.",
    },
  ];
    ...
    <div className="min-h-screen bg-slate-50 font-sans">
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white font-heading leading-tight">
                  Chiropractic <span className="text-white/90">Care</span>{" "}
                  <br />
                  in Delhi
                </h1>
                <p className="text-white/90 font-body">
                  At Kynexa, we provide Chiropractic Care in Delhi to relieve
                  pain and restore musculoskeletal health. Our hands-on spinal
                  and joint adjustments help improve posture, nerve function,
                  and natural healing. From chronic back pain to mobility
                  issues, our certified chiropractors offer safe, personalized
                  care to help you move better and feel your best.
                </p>
            ...
            <div className="relative">
              <div className="relative z-10 bg-white rounded-3xl p-6 lg:p-0 shadow-lg">
                <Image
                  src="/chiro/Chiropractic-Care-Main.jpg"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative order-2 lg:order-1">
              <div className="relative z-10 bg-white rounded-3xl p-6 lg:p-0 shadow-lg">
                <Image
                  src="/chiro/Chiropractic-Care-What.jpg"
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                  Chiropractic therapy uses hands-on techniques to align the
                  spine and musculoskeletal system, promoting pain relief and
                  improved movement without drugs or invasive procedures. By
                  correcting misalignments (subluxations), chiropractic
                  adjustments help reduce nerve irritation, improve joint
                  movement, and support better posture and balance.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  Unlike symptomatic treatments, chiropractic care addresses the
                  root mechanical causes of dysfunction—especially in the spine,
                  pelvis, and shoulders. It’s widely used for managing back
                  pain, neck pain, sciatica, headaches, and posture-related
                  issues resulting from lifestyle strain or injury.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-slate-50 py-8 px-4 sm:px-6 lg:px-8 rounded-xl shadow-md">
          <div className="text-center mt-8">
            <p className="text-xl text-gray-700 font-semibold">
              Its safe for people of all age groups - from working professionals
              and athletes to senior seeking natural pain relief.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-6xl mx-auto">
              After a thorough spinal assessment and postural analysis, our
              chiropractor identifies joint misalignments or movement
              restrictions. Based on your findings and history, we perform
              controlled, precise manual adjustments to restore normal motion
        ...
        <div className="bg-slate-50 py-8 px-4 sm:px-6 lg:px-8 rounded-xl shadow-md">
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            <p className="text-xl text-gray-700 font-semibold">
              Your care plan evolves session by session based on how your body
              responds, with constant feedback and education.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative z-10 bg-white rounded-3xl p-6 lg:p-0 shadow-lg">
                <Image
                  src="/chiro/Chiropractic-Care-Benefits.jpg"
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#6c2c8b] font-heading">
              Why Choose Kynexa for Chiropractic Care?
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative order-2 lg:order-1">
              <div className="relative z-10 bg-white rounded-3xl p-6 lg:p-0 shadow-lg">
                <Image
                  src="/chiro/Chiropractic-Care-Why.jpg"
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2">
              <p className="text-xl  text-gray-700 font-semibold leading-relaxed mb-6">
                We go beyond cracking spines—we deliver intentional, controlled
                adjustments that align with your healing goals and lifestyle.
              </p>
              <div className="space-y-4">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-6xl mx-auto">
              Your first chiropractic session will begin with a detailed
              assessment including posture screening, spinal motion tests, and
              functional movement analysis. Based on findings, we will:
            </p>
          </div>
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            ...
            <p className="text-lg text-gray-700 font-semibold">
              Every visit is tailored to your progress, comfort, and overall
              well-being.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            ...
            <p className="text-lg text-white/80 font-body leading-relaxed">
              Say goodbye to constant strain and stiffness. Let Kynexa’s
              chiropractic care in Delhi help realign your spine, reboot your
              system, and refresh your movement.
            </p>
            <p className="text-sm text-white/70 font-body">
              Virtual consultations and postural evaluations available by
              appointment.
            </p>
          </div>

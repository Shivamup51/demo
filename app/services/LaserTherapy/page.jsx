...
export default function LaserTherapyPage() {
  ...
  const laserMechanisms = [
    ...
    },
    {
      ...
      description:
        "Decreases production of pro-inflammatory mediators, helping minimize swelling and speed up tissue recovery.",
  ...
  const faqs = [
    {
      question:
        "What's the difference between low-level and high-power laser therapy?",
      answer:
        "Low-level laser is ideal for mild or superficial conditions, while high power laser penetrates deeper tissues and offers quicker results for chronic or complex issues.",
    },
    {
      question: "How many sessions are needed?",
      answer:
        "Acute conditions may improve in 3–5 sessions; deeper or long-standing issues may require 8–10, especially when using high power modalities.",
    },
    {
      question: "Can laser therapy be combined with other treatments?",
      answer:
        "Absolutely. It complements manual therapy, exercise rehab, dry needling, and spinal alignment for comprehensive recovery.",
    },
    {
      question: "Is it safe?",
      answer:
        "Yes, both LLLT and HPLT are FDA-approved and safe when administered by certified professionals.",
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                ...
                <p className="text-xl text-white/90 font-body">
                  Light-Powered Healing for Pain-Free Living
                </p>
                <p className="text-lg text-white/80 font-body max-w-lg leading-relaxed">
                  ...
                  offer both Low-Level Laser Therapy (LLLT) and High-Power Laser
                  Therapy (HPLT) in Delhi to accelerate healing, reduce pain,
                  and restore mobility. These non-invasive, scientifically
                  backed treatments use therapeutic light energy to stimulate
                  cellular regeneration, improve tissue health, and reduce
                  inflammation—making laser therapy a cornerstone of modern
                  rehabilitation care.
                </p>
              </div>
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                  Laser therapy involves the application of medical-grade laser
                  light to injured or painful areas to stimulate healing from
                  within. While LLLT uses low-intensity light ideal for surface
                  tissues and mild conditions, HPLT emits powerful wavelengths
                  that reach deeper muscle, ligament, and joint tissues, making
                  it a more efficient solution for advanced musculoskeletal
                  concerns.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  Unlike surgical lasers, both forms of therapy are
                  non-destructive and do not involve cutting or burning. They
                  work by stimulating natural cellular functions without pain,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-6xl mx-auto">
              Laser therapy functions through photo biomodulation, a cellular
              process where light energy is absorbed and converted into
              biological repair signals. Here's how:
            </p>
          </div>
              ...
              >
                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    <div className="text-[#9d4ed8]">{mechanism.icon}</div>
                    <h3 className="text-lg font-semibold text-[#6c2c8b]">
                      {mechanism.title}
                    </h3>
                  </div>
          ...
          <div className="text-center bg-white p-6 rounded-xl shadow-sm">
            ...
            <p className="text-lg text-gray-700 font-body">
              High Power Laser Therapy offers enhanced outcomes in fewer
              sessions by delivering more energy per minute, especially
              beneficial for chronic pain, deep-seated injuries, and
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-3xl mx-auto">
              Laser therapy at Kynexa is effective for a wide spectrum of
                ...
                <CardContent className="p-6">
                  <div className="text-center mb-4">
                    <div className="w-10 h-10 bg-[#6c2c8b]/10 rounded-full flex items-center justify-center mx-auto">
                      <span className="text-lg font-bold text-[#6c2c8b]">
                        {index + 1}
                      </span>
                    </div>
                  </div>
                  <p className="text-gray-700 font-body text-center text-base leading-relaxed">
                    {step}
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold text-white font-heading">
              Book Your Laser Therapy Appointment
            </h2>
            <p className="text-lg text-white/80 font-body leading-relaxed">
              Explore the benefits of High-Power Laser Therapy with Kynexa's
              expert physiotherapy team. Experience faster healing, deeper
              relief, and better mobility—powered by light.
            </p>
          </div>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  >
                    <h3 className="text-lg font-medium text-[#6c2c8b]">
                      {faq.question}
                    </h3>
                    {expandedFaq === index ? (

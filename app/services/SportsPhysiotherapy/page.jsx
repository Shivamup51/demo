  ...
  const treatmentApproach = [
    {
      ...
      description:
        "A detailed evaluation of injury mechanism, joint integrity, soft tissue condition, and functional deficits",
      icon: <FaRegChartBar className="w-7 h-7" />,
    },
    {
      title: "Manual Therapy and Joint Mobilization",
      description:
        "Hands-on techniques to restore joint mechanics, relieve pain, and improve overall mobility",
      icon: <FaUserMd className="w-7 h-7" />,
    },
    {
      title: "Customized Exercise Prescription",
      description:
        "Targeted strength, flexibility, and neuromuscular exercises based on your sport, injury stage, and performance goals",
      icon: <IoFitnessOutline className="w-7 h-7" />,
    },
    {
      title: "Biomechanical Correction",
      description:
        "Focused retraining to correct faulty movement patterns that contribute to repeated injuries",
      icon: <FaBriefcaseMedical className="w-7 h-7" />,
    },
    {
      title: "Taping and Bracing",
      description:
        "Supportive strategies to stabilize vulnerable areas during healing and training",
      icon: <FaUserMd className="w-7 h-7" />,
    },
    {
      title: "Return-to-Sport Testing",
      description:
        "Evidence-based milestones that guide safe transition back to play or competition",
      icon: <FaRegChartBar className="w-7 h-7" />,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Not at all! Anyone with an active lifestyle, from gym-goers to dancers, can benefit.",
    },
    {
      question: "Can this help with recurring injuries?",
      answer:
        "Absolutely. We target the root causes of strain and equip you with tools to prevent recurrence.",
    },
    {
      question: "Do I need a doctor’s referral?",
      answer:
        "No referral is needed. You can book an initial assessment directly with our team.",
    },
  ];
    ...
    <div className="min-h-screen bg-slate-50 font-sans">
            ...
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                ...
                <p className="text-xl text-white/90 font-body">
                  Powering Performance, Preventing Injury
                </p>
                <p className="text-lg text-white/80 font-body max-w-lg leading-relaxed">
                  ...
                  provide specialized Sports Physiotherapy in Delhi to help
                  athletes of all levels recover faster, move better, and
                  perform at their peak. Our evidence-based approach is tailored
                  to the unique demands of your sport, addressing injuries,
                  movement inefficiencies, and performance limitations. Whether
                  you're a competitive athlete, weekend warrior, or fitness
                  enthusiast, our physiotherapists design every session to
                  restore function, prevent re-injury, and elevate your game
                  with precision care.
                </p>
              </div>
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                  A dedicated branch of physiotherapy, sports physiotherapy
                  targets the prevention and rehabilitation of sports-related
                  injuries. At Kynexa Advanced Physiotherapy and Manual Therapy
                  Clinic in Delhi, our sports physio team is trained to evaluate
                  movement, biomechanics, and musculoskeletal health with
                  precision—catering to everyone from professional athletes to
                  weekend warriors.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  Whether you're recovering from an acute injury, managing
                  chronic strain, or simply aiming to improve performance, we
                  tailor each session to your unique sport, position, and
                  training load. Our comprehensive approach includes strength
                  conditioning, flexibility training, functional movement
                  correction, and injury risk assessment. By addressing both
                  current concerns and potential vulnerabilities, we help
                  athletes build resilience, enhance efficiency, and return to
                  sport safely and confidently.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-8xl mx-auto">
              Our approach to Sports Physiotherapy blends in-depth clinical
              assessment with goal-driven functional rehabilitation to support
              every stage of your recovery and performance journey. We combine
              advanced techniques with sport-specific insights to not only treat
              current injuries but also enhance overall biomechanics and prevent
              future setbacks.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#6c2c8b] font-heading">
              Why Choose Kynexa for Sports Physio?
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative order-2 lg:order-1">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-8xl mx-auto">
              Every client begins with a detailed physical and functional
              assessment. We study how you move, load, and recover. From there,
              we develop an action plan that balances rehab, conditioning, and
              sports-specific drills—paving your path from recovery to peak
              performance.
            </p>
          </div>
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            ...
            <p className="text-lg text-gray-700 font-body">
              You’ll receive real-time corrections and education on technique,
              posture, warm-ups, and recovery strategies.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            ...
            <p className="text-lg text-white/80 font-body leading-relaxed">
              Reclaim your edge and play without pain. Schedule your customized
              sports physiotherapy session now and take the first step toward
              peak performance.
            </p>
            <p className="text-lg text-white/80 font-body leading-relaxed">

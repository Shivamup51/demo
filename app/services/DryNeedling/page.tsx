  ...
  const treatmentApproach = [
    {
      ...
      description:
        "Stimulate a local twitch response, which helps release the tight band",
    ...
    },
    {
      ...
      description:
        "Stimulate the body's natural pain relief response, triggering the release of endorphins",
  ...
  const faqs = [
    {
      ...
      answer:
        "No. Dry needling follows Western medical principles and targets muscle trigger points, while acupuncture is based on traditional Chinese medicine.",
    },
    {
      question: "Does dry needling hurt?",
      answer:
        "Not much. You might feel a quick twitch or mild ache, but it’s usually well-tolerated and short-lived.",
    },
    {
      question: "What conditions does it treat?",
      answer:
        "It helps with neck/back pain, sciatica, shoulder injuries, TMJ issues, and sports muscle tightness.",
    },
    {
      question: "How many sessions are needed?",
      answer:
        "Depends on the case. Some feel better after one session, while others may need a few more for full relief.",
    },
  ];
    ...
    <div className="min-h-screen bg-slate-50 font-sans">
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white font-heading leading-tight">
                  Dry Needling <span className="text-white/90">Therapy</span> in
                  Delhi
                </h1>
                <div className="h-1 w-20 bg-white/40 rounded"></div>
                <p className="text-xl text-white/90 font-body">
                  Precision Healing for Pain-Free Living
                </p>
                <p className="text-lg text-white/80 font-body max-w-lg leading-relaxed">
                  At Kynexa Advanced Physiotherapy Manual Therapy Clinic, we
                  offer Dry Needling therapy in Delhi as part of our advanced,
                  evidence-based physiotherapy services. This powerful technique
                  is designed to release muscle tension, reduce pain, and
                  restore optimal movement patterns. Whether you're an athlete
                  recovering from injury, a professional dealing with postural
                  strain, or someone managing chronic pain, our expert
                  physiotherapists tailor each session to your unique needs.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="relative z-10 bg-white rounded-3xl p-6 lg:p-0 shadow-lg">
                <Image
                  src="/dry/dry-needling-banner.jpg"
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                  ...
                  inserting ultra-fine, sterile needles into specific myofascial
                  trigger points—commonly known as muscle knots. These trigger
                  points are hyperirritable spots in skeletal muscle that can
                  cause pain, stiffness, and restricted movement.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  Unlike acupuncture, which is rooted in traditional Chinese
                  medicine, dry needling is grounded in Western medicine and
                  neuroanatomy. It targets the neuromuscular system to stimulate
                  a healing response, improve blood flow, and normalize muscle
                  function. It’s a cornerstone of physiotherapy services in
                  Delhi for treating musculoskeletal dysfunctions.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-7xl mx-auto">
              When a muscle is overused or injured, it can form tight bands of
              tissue that limit blood flow and reduce oxygen supply. This
              creates an "energy crisis" within the muscle, leading to pain and
              impaired function. By inserting a needle directly into the trigger
              point, we:
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative z-10 bg-white rounded-3xl p-6 lg:p-0 shadow-lg">
                <Image
                  src="/dry/dry-needling-benefit.jpg"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-3xl mx-auto">
              Our dry needling therapy in Delhi is effective for a wide range of
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#6c2c8b] font-heading">
              Why Choose Kynexa Advanced Physiotherapy?
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative order-2 lg:order-1">
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2">
              <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                At Kynexa, we combine clinical expertise with compassionate care
                to deliver exceptional physiotherapy in Delhi. Here’s what sets
                us apart:
              </p>
              <div className="space-y-4">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-7xl mx-auto">
              Your first session begins with a comprehensive assessment of your
              condition, posture, and movement patterns. Based on this, we
              identify the trigger points contributing to your pain and
              dysfunction.
            </p>
          </div>
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            ...
            <p className="text-lg text-gray-700 font-body">
              We’ll also guide you through post-needling care, including
              hydration, gentle movement, and follow-up exercises to maximize
              results.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            ...
            <p className="text-lg text-white/80 font-body leading-relaxed">
              If you're searching for dry needling therapy in Delhi that
              delivers real results, look no further than Kynexa Advanced
              Physiotherapy and Manual Therapy Clinic. We're here to help you
              move with ease, feel stronger, and live free from pain.
            </p>
          </div>

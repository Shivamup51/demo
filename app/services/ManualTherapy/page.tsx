...
export default function ManualTherapyPage() {
  ...
  const whatToExpect = [
    ...
    {
      title:
        "Post-session guidance on exercises, stretches, and lifestyle hacks to maintain progress",
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes, when administered by trained professionals, it’s safe and highly effective. Your treatment plan is always adapted to your specific needs.",
    },
    {
      question: "How many sessions are required?",
      answer:
        "That depends on your condition. While some clients feel immediate relief, chronic issues may require ongoing care.",
    },
    {
      question: "Will I feel pain during the session?",
      answer:
        "Some techniques may feel intense, but they are never harmful. We constantly check your comfort level throughout the process.",
    },
    {
      question: "Can manual therapy be combined with other treatments?",
      answer:
        "Absolutely. It works best when integrated with physiotherapeutic exercises, dry needling, or modalities like cupping and laser therapy.",
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                ...
                <p className="text-xl text-white/90 font-body">
                  Hands-On Relief. Lasting Results.
                </p>
                <p className="text-lg text-white/80 font-body max-w-lg leading-relaxed">
                  ...
                  our Manual Therapy services in Delhi offer a hands-on path to
                  healing, designed to relieve pain, restore joint mobility, and
                  improve overall function. This specialized approach uses
                  skilled techniques like joint mobilization, myofascial
                  release, and soft tissue manipulation to target the root
                  causes of discomfort. Whether you're managing postural
                  imbalances, recovering from surgery, or dealing with chronic
                  pain conditions, our physiotherapists craft each session to
                  address your unique needs and restore natural movement with
                  precision and care.
                </p>
              </div>
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  Manual Therapy is a specialized, hands-on approach used by our
                  skilled physiotherapists to diagnose, treat, and manage
                  musculoskeletal dysfunctions. Unlike machine-based treatments,
                  manual therapy involves controlled movements and pressure
                  applied directly to muscles, joints, and connective tissues to
                  reduce pain, improve mobility, and restore natural movement
                  patterns.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  It is particularly effective for those suffering from joint
                  stiffness, restricted range of motion, or soft tissue
                  injuries. By physically engaging the body’s structures through
                  targeted techniques, manual therapy not only relieves symptoms
                  but also improves circulation, encourages proper alignment,
                  and supports long-term functional independence. Each session
                  is crafted based on individual needs, making it a cornerstone
                  of personalized care at Kynexa.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-8xl mx-auto">
              Manual therapy techniques work by physically mobilizing restricted
              joints and decompressing tight soft tissues. This encourages
              better blood flow, reduces pain signaling from nerves, and
              improves overall movement quality. Common techniques we use
              include:
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center">
            <div className="space-y-6 p-6 text-center">
              <h2 className="text-3xl sm:text-4xl font-bold text-[#6c2c8b] font-heading">
                Myofascial Release: A Core Component
              </h2>
              <div className="prose prose-lg max-w-none mx-auto">
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  One of the cornerstones of our manual therapy approach is
                  Myofascial Release, a technique designed to stretch and
                  release tension in the fascia—the connective tissue that
                  surrounds your muscles and organs.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  Tight fascia can restrict movement, create chronic pain
                  patterns, and affect posture. Through slow, sustained
                  pressure, we target specific myofascial restrictions, helping
                  to:
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto mt-8">
                {myofascialRelease.map((item, index) => (
                  <div
                    key={index}
                    className="flex items-start space-x-3 bg-white p-4 rounded-lg shadow-sm text-left"
                  >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-8xl mx-auto">
              Your first appointment includes a comprehensive assessment of
              posture, mobility, and functional strength. Based on your
              condition, we apply a combination of manual techniques to target
              the root cause of discomfort—not just the symptoms. Expect:
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            ...
            <p className="text-lg text-white/80 font-body leading-relaxed">
              Ready to move freely and painlessly again? Let Kynexa’s manual
              therapy experts guide your recovery journey. Also available for
              online consultations and treatment planning.
            </p>
          </div>

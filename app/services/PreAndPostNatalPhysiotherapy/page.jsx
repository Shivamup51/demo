  ...
  const howItWorks = [
    {
      ...
      description:
        "To strengthen deep stabilizers and reduce strain during lifting and feeding.",
      icon: <FaUserMd className="w-8 h-8" />,
    },
    {
      title: "Breathing Exercises & Mobility Drills",
      description:
        "To enhance relaxation, support labor prep, and improve postpartum recovery.",
      icon: <FaHeartbeat className="w-8 h-8" />,
    },
    {
      title: "Core, Glute & Back Strengthening",
      description:
        "To improve stability, reduce fatigue, and address pelvic or sacroiliac pain.",
      icon: <IoFitnessOutline className="w-8 h-8" />,
    },
    {
      title: "Manual Therapy",
      description:
        "To relieve muscular tension and correct imbalances in the spine, hips, and upper back.",
      icon: <FaBriefcaseMedical className="w-8 h-8" />,
    },
    {
      title: "Education on Ergonomics & Positioning",
      description:
        "For safer movement during daily tasks like lifting your baby or sleeping.",
      icon: <FaHospital className="w-8 h-8" />,
    },
    {
      title: "Scar Tissue Management",
      description:
        "For improved healing and mobility after C-section or episiotomy.",
  ...
  const whatToExpect = [
    {
      ...
      description:
        "Comprehensive evaluation of posture, pelvic alignment, core strength, and mobility.",
      icon: <FaUserMd className="w-8 h-8" />,
    },
    {
      title: "Personalized Plan",
      description:
        "Customized care plan tailored to your trimester or postpartum stage.",
      icon: <FaBriefcaseMedical className="w-8 h-8" />,
    },
    {
      title: "Therapeutic Exercises",
      description:
        "Safe exercises to strengthen core, pelvic floor, and improve mobility.",
      icon: <IoFitnessOutline className="w-8 h-8" />,
    },
    {
      title: "Manual Therapy",
      description:
        "Hands-on techniques to relieve tension and correct imbalances.",
      icon: <FaHeartbeat className="w-8 h-8" />,
    },
    {
      title: "Ongoing Support",
      description:
        "Education and home exercises to maintain progress between sessions.",
      icon: <Heart className="w-8 h-8" />,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes! All sessions are designed by professionals to be safe for both mother and baby at every stage.",
    },
    {
      question: "When can I start postnatal therapy?",
      answer:
        "Most women can begin gentle therapy 6 weeks after delivery, or sooner with doctor clearance.",
    },
    {
      question: "Can it help with C-section recovery?",
      answer:
        "Absolutely. We address scar tissue, posture, and core strength to aid healing.",
    },
    {
      question: "Do I need a doctor’s referral?",
      answer:
        "Not required! You can directly book an assessment with our women’s health team.",
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white font-heading leading-tight">
                  Pre and <span className="text-white/90">Post Natal</span>{" "}
                  <br />
                  Physiotherapy{" "}
                  <span className="text-xl sm:text-2xl font-medium block mt-2">
                    in Delhi
                  </span>
                </h1>
                <p className="text-white/90 font-body">
                  At Kynexa in Delhi, we offer expert Pre and Post Natal
                  Physiotherapy to support women through pregnancy and
                  postpartum recovery. Our personalized care relieves pain,
                  improves posture, and strengthens the core and pelvic floor.
                  Whether expecting or healing post-birth, our therapists
                  provide tailored guidance to help you feel stronger, more
                  balanced, and confident throughout your motherhood journey.{" "}
                </p>
                <p className="text-xl text-white/90 font-body">
                  Empowering Mothers Through Every Stage of Motherhood
                </p>
              </div>
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                  Pre and Post Natal Physiotherapy focuses on maintaining
                  physical health and functional mobility before and after
                  childbirth. During pregnancy, a woman’s body goes through
                  dramatic changes in posture, weight distribution, hormonal
                  balance, and muscle strength—often leading to discomfort or
                  mobility issues.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  This therapy combines safe exercises, hands-on techniques, and
                  patient education to effectively address conditions like
                  pelvic girdle pain, diastasis recti, and core dysfunction.
                  Postnatally, we help restore stability, rebuild strength, and
                  support mothers in safely resuming activity, including
                  lifting, carrying, and returning to sport or work.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-3xl mx-auto">
              This program is designed for expecting and new mothers
              experiencing:
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-8xl mx-auto">
              Our Pre and Postnatal Physiotherapy programs begin with a
              comprehensive assessment of your posture, pelvic alignment, core
              strength, and any areas of discomfort or mobility restriction.
              Based on this, our experienced physiotherapists design a
              customized care plan that prioritizes safety, function, and
              confidence.
            </p>
          </div>
              ...
              >
                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    <div className="text-[#9d4ed8]">{approach.icon}</div>
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            ...
            <p className="text-lg text-gray-700 font-body">
              Each program is paced according to your trimester or healing phase
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="space-y-6 p-6 lg:p-0 order-2 lg:order-1">
              <h2 className="text-3xl sm:text-4xl font-bold text-[#6c2c8b] font-heading">
                Benefits for Expecting and New Mothers
              </h2>
              <div className="space-y-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2">
              <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                We understand that pregnancy and postpartum recovery are
                transformative journeys. At Kynexa, we provide compassionate,
                expert care to help you feel stronger, more confident, and ready
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            <Info className="w-8 h-8 text-[#9d4ed8] mx-auto mb-3" />
            <p className="text-lg text-gray-700 font-body">
              You’ll also receive home care strategies, self-monitoring tips,
              and exercises to maintain progress between sessions.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            ...
            <p className="text-lg text-white/80 font-body leading-relaxed">
              Prioritize your well-being before and after childbirth with expert
              pre- and post-natal physiotherapy care at Kynexa.
            </p>
            <p className="text-sm text-white/70 font-body">
              Home visit and online consultation options available.
            </p>
          </div>

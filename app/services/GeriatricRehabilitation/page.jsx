...
export default function GeriatricRehabilitationPage() {
  ...
  const faqs = [
    {
      question:
        "Is this program safe for elderly patients with multiple health conditions?",
      answer:
        "Yes. Every session is medically supervised, and programs are tailored to individual needs and tolerance.",
    },
    {
      question: "How soon after a fall or surgery can one begin rehab?",
      answer:
        "Usually within a few days to weeks, depending on medical clearance. Sooner rehab often leads to faster recovery.",
    },
    {
      question: "Can you help someone using a walker or wheelchair?",
      answer:
        "Absolutely. We adapt exercises and training to suit all mobility levels, including those needing assistive devices.",
    },
    {
      question: "Do you offer family education?",
      answer:
        "Yes, we educate caregivers and families on safe transfers, exercises, and daily movement support.",
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                ...
                <p className="text-white/90 font-body">
                  At Kynexa in Delhi, our Geriatric Rehabilitation program helps
                  older adults stay independent and mobile through targeted
                  balance and gait training. Whether recovering from surgery,
                  injury, or managing age-related weakness and stiffness, our
                  team offers personalized, compassionate care to improve
                  safety, stability, and confidence in daily life.
                </p>

                <p className="text-xl text-white/90 font-body">
                  Strength. Stability. Safe Independence.
                </p>
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                  Geriatric Rehabilitation is a specialized branch of
                  physiotherapy that focuses on helping older adults recover
                  from injuries, adapt to age-related changes, and preserve
                  their independence. As we age, issues like reduced balance,
                  slower reaction time, joint degeneration, and chronic
                  conditions (like arthritis or osteoporosis) can affect our
                  ability to move safely and confidently.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  At Kynexa, we offer personalized rehabilitation plans that
                  include strength training, balance enhancement, joint
                  mobility, and gait improvement, aiming to reduce fall risk,
                  support post-surgical recovery, and restore confidence in
                  movement—at any age.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-8">
            <p className="text-lg text-gray-700 font-body">
              Even individuals who are relatively healthy benefit from proactive
              rehabilitation focused on mobility preservation and fall
              prevention.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-8xl mx-auto">
              We begin with a comprehensive geriatric functional assessment
              including posture, balance, gait, flexibility, muscular strength,
              and overall coordination. Based on this, your therapist develops a
              progressive plan that may include:
            </p>
          </div>
          <div className="space-y-12">
            {/* Balance Training */}
            <div className="mt-12">
              <h3 className="text-2xl font-bold text-[#6c2c8b] font-heading mb-6 text-center">
                Balance Training
              </h3>
          ...
          <div className="text-center mt-8">
            <p className="text-lg text-gray-700 font-body">
              Every element is adapted to your current condition and gradually
              intensified as progress is achieved.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2">
              <h2 className="text-3xl sm:text-4xl font-bold text-[#6c2c8b] font-heading">
                Why Choose Kynexa for Senior Rehab?
              </h2>
              <div className="space-y-4">
              ...
              <div className="text-lg text-gray-700 font-body mt-4">
                At Kynexa, we treat older adults with the warmth of family and
                the precision of science—empowering graceful, safe aging.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold text-white font-heading">
              Book Your Geriatric Rehab Consultation
            </h2>
            <p className="text-lg text-white/80 font-body leading-relaxed">
              Support yourself or a loved one in staying strong, upright, and
              independent with Kynexa’s expert geriatric rehabilitation in
              Delhi. In-home physiotherapy and caregiver training also available
              upon request.
            </p>
          </div>

  ...
  const treatmentApproach = [
    {
      ...
      description:
        "Cold therapy, elevation, TENS, and gentle manual drainage techniques",
      icon: <FaBriefcaseMedical className="w-7 h-7" />,
    },
    {
      title: "Mobility Restoration",
      description:
        "Passive and active range of motion (ROM) exercises to improve joint flexibility",
      icon: <IoFitnessOutline className="w-7 h-7" />,
    },
    {
      title: "Strengthening Exercises",
      description:
        "Gradual resistance work to rebuild muscle support around the affected area",
      icon: <FaUserMd className="w-7 h-7" />,
    },
    {
      title: "Scar Tissue Mobilization",
      description:
        "Manual release and soft tissue techniques to improve tissue pliability",
    ...
    },
    {
      ...
      description:
        "Simulated daily activities like stair climbing, sitting/standing transitions, and carrying loads",
      icon: <FaUserMd className="w-7 h-7" />,
    },
    {
      title: "Home Exercise Program",
      description:
        "Continuation exercises for between sessions or after discharge",
      icon: <FaRegChartBar className="w-7 h-7" />,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "It varies by procedure, but many rehab programs begin within 24–72 hours. We align with your surgeon’s timeline.",
    },
    {
      question: "Can rehab prevent surgical complications?",
      answer:
        "Yes. Physiotherapy reduces the risk of joint stiffness, clotting, muscle wasting, and loss of function.",
    },
    {
      question: "Will my rehab program be painful?",
      answer:
        "Some discomfort is normal, but sessions are adapted to your healing phase and pain tolerance.",
    },
    {
      question: "How long will it take to fully recover?",
      answer:
        "Recovery timelines differ depending on the surgery, but consistent therapy can dramatically improve speed and quality of recovery.",
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                ...
                <p className="text-xl text-white/90 font-body">
                  Rebuild Strength. Restore Mobility. Regain Confidence.
                </p>
                <p className="text-lg text-white/80 font-body max-w-lg leading-relaxed">
                  ...
                  our Post-Surgical Rehabilitation services in Delhi are
                  designed to help you recover faster, safer, and smarter after
                  surgery. We understand that surgery is just the first step;
                  the real progress comes through targeted rehabilitation that
                  restores mobility, reduces pain, and rebuilds functional
                  strength. Whether you've undergone joint replacement, spinal
                  surgery, or a soft tissue procedure, our tailored recovery
                  plans are crafted to match your procedure, healing timeline,
                  and lifestyle goals.
                </p>
              </div>
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                  Post-Surgical Rehabilitation is a structured physiotherapy
                  program that begins shortly after surgery to promote healing,
                  restore movement, prevent complications, and help patients
                  return to daily activities. At Kynexa, we collaborate with
                  your surgeon’s protocol and provide progressive interventions
                  that align with your healing phase—whether you're in the
                  hospital, at home, or transitioning to full mobility.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  Our approach is centered on early mobilization, pain
                  management, and personalized exercise prescription. From
                  regaining joint flexibility to rebuilding muscle strength, we
                  work to ensure your surgical outcome is successful—and
                  long-lasting.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            ...
            <p className="text-lg text-gray-700 font-body">
              Whether you’re recovering from a major orthopedic procedure or a
              minimally invasive surgery, we’ll customize a rehab plan to meet
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-8xl mx-auto">
              Our program begins with a detailed post-operative assessment,
              taking into account your surgical procedure, healing stage,
              swelling, joint range, pain level, and overall strength.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2">
              <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                We’re not just restoring joints—we’re helping you reclaim your
                independence, resilience, and everyday confidence.
              </p>
              <div className="space-y-4">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold text-white font-heading">
              Book Your Rehabilitation Plan Today
            </h2>
            <p className="text-lg text-white/80 font-body leading-relaxed">
              Start your healing journey with Kynexa’s expert post-surgical
              rehabilitation in Delhi. We’ll help you move forward with
              strength, precision, and care.
            </p>
            <p className="text-lg text-white/80 font-body leading-relaxed">
              Home visits and online consultations available for eligible
              patients.
            </p>
          </div>

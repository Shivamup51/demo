  ...
  const treatmentApproach = [
    {
      ...
      description:
        "Focused muscle retraining and re-education for weakened limbs and postural control",
      icon: <IoFitnessOutline className="w-7 h-7" />,
    },
    {
      title: "Gait & Balance Training",
      description:
        "Using parallel bars, body-weight supported treadmills, and dynamic balance tools",
      icon: <FaBriefcaseMedical className="w-7 h-7" />,
    },
    {
      title: "Neurofacilitation Techniques",
      description:
        "Promote voluntary movement through guided stimuli and patterning (PNF, NDT)",
      icon: <FaUserMd className="w-7 h-7" />,
    },
    {
      title: "Task-Specific Therapy",
      description:
        "Practicing real-life activities like standing, grasping objects, or climbing stairs",
      icon: <FaRegChartBar className="w-7 h-7" />,
    },
    {
      title: "Mirror Therapy & Sensory Integration",
      description:
        "Enhancing brain feedback and improving perception or proprioception",
      icon: <IoFitnessOutline className="w-7 h-7" />,
    },
    {
      title: "Coordination Drills & Hand Therapy",
      description:
        "To improve fine motor control and bilateral limb integration",
      icon: <FaBriefcaseMedical className="w-7 h-7" />,
    },
    {
      title: "Manual Therapy & Spasticity Management",
      description:
        "Relieving tone, improving joint mobility, and addressing muscle imbalances",
      icon: <FaUserMd className="w-7 h-7" />,
    },
    {
      title: "Cognitive-Motor Integration",
      description:
        "Exercises that merge physical movement with mental tasks to rebuild attention, memory, and decision-making during activity",
      icon: <FaRegChartBar className="w-7 h-7" />,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "It depends on your condition and goals. Some patients recover function in weeks; others need longer-term therapy.",
    },
    {
      question: "Can elderly patients benefit?",
      answer:
        "Absolutely. Our programs are tailored to all age groups and adjusted to personal tolerance and safety.",
    },
    {
      question: "Is this only for stroke recovery?",
      answer:
        "No. We also treat spinal injuries, Parkinson’s, MS, brain injury, and more.",
    },
    {
      question: "Do I need a neurologist’s referral?",
      answer:
        "Not mandatory, but we do coordinate with your doctors if you’re under ongoing medical care.",
    },
  ];
    ...
    <div className="min-h-screen bg-slate-50 font-sans">
            ...
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white font-heading leading-tight">
                  ...
                  <span className="text-white/90">in Delhi</span>
                </h1>
                <div className="h-1 w-20 bg-white/40 rounded"></div>
                <p className="text-xl text-white/90 font-body">
                  Rewiring Movement. Restoring Independence. Reclaiming Life.
                </p>
                <p className="text-lg text-white/80 font-body max-w-lg leading-relaxed">
                  ...
                  offer specialized Neuro Rehabilitation in Delhi to support
                  individuals navigating the physical and cognitive challenges
                  that come with neurological injuries and disorders. Whether
                  you're recovering from a stroke, managing the long-term
                  effects of Parkinson’s, or rebuilding balance after a spinal
                  cord injury, our expert neuro-physiotherapists combine skill,
                  compassion, and technology to help you regain confidence and
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                  Neuro Rehabilitation is a specialized branch of physiotherapy
                  focused on improving the quality of life for individuals with
                  neurological impairments caused by conditions like stroke,
                  traumatic brain injury, spinal cord injury, multiple
                  sclerosis, or cerebral palsy. It involves structured,
                  progressive therapies that retrain the brain and nervous
                  system to regain function, adapt to changes, or compensate for
                  limitations.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  At Kynexa, we go beyond exercises—we emphasize neuroplasticity
                  (the brain’s ability to reorganize and adapt) through
                  functional movement training, sensory retraining, balance and
                  gait work, and task-specific drills. Our ultimate goal is to
                  reduce dependence, restore movement, and empower long-term
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            ...
            <p className="text-lg text-gray-700 font-body">
              We welcome both recent and chronic cases, customizing each plan
              based on functional status, age, goals, and prognosis.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-8xl mx-auto">
              Each journey begins with a neurological assessment covering
              strength, tone, reflexes, balance, gait, coordination, and
              cognitive integration. Based on findings, we design a
              goal-oriented rehabilitation plan that may include:
            </p>
          </div>
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            <Info className="w-8 h-8 text-[#9d4ed8] mx-auto mb-3" />
            <p className="text-lg text-gray-700 font-body">
              Cognitive-Motor Integration – Exercises that merge physical
              movement with mental tasks to rebuild attention, memory, and
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#6c2c8b] font-heading">
              Why Choose Kynexa for Neuro Rehab?
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative order-2 lg:order-1">
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2">
              <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                At Kynexa, we don’t just treat conditions—we walk the recovery
                journey with you, helping you rediscover function, dignity, and
                purpose.
              </p>
              <div className="space-y-4">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            <Info className="w-8 h-8 text-[#9d4ed8] mx-auto mb-3" />
            <p className="text-lg text-gray-700 font-body">
              As your function improves, we incorporate greater complexity to
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            ...
            <p className="text-lg text-white/80 font-body leading-relaxed">
              Neuro recovery is possible—with the right care, consistency, and
              compassion. Let Kynexa’s Neuro Rehabilitation experts help you
              reclaim movement, confidence, and independence.
            </p>
            <p className="text-lg text-white/80 font-body leading-relaxed">

  ...
  const treatmentApproach = [
    {
      ...
      description:
        "Low to moderate-intensity aerobic training (walking, cycling) to improve cardiovascular endurance",
      icon: <IoFitnessOutline className="w-7 h-7" />,
    },
    {
      title: "Respiratory Physiotherapy",
      description:
        "Includes breathing retraining, lung expansion techniques, and airway clearance",
      icon: <FaLungs className="w-7 h-7" />,
    },
    {
      title: "Monitoring & Safety",
      description:
        "Continuous vital monitoring (heart rate, SpO₂, blood pressure) ensures a safe rehabilitation environment",
      icon: <FaHeartbeat className="w-7 h-7" />,
    },
    {
      title: "Strength and Flexibility Workouts",
      description:
        "Improve muscle function, reduce fatigue, and support joint mobility",
      icon: <IoFitnessOutline className="w-7 h-7" />,
    },
    {
      title: "Postural & Chest Mobility Training",
      description:
        "To improve lung expansion and prevent breathlessness on exertion",
      icon: <FaLungs className="w-7 h-7" />,
    },
    {
      title: "Stress Reduction Techniques",
      description:
        "Guided relaxation, diaphragmatic breathing, and energy conservation strategies",
      icon: <Heart className="w-7 h-7" />,
    },
    {
      title: "Lifestyle Counseling & Nutritional Support",
      description:
        "Manage risk factors and build healthy habits for long-term heart-lung health",
      icon: <IoNutritionOutline className="w-7 h-7" />,
    },
    {
      title: "Education & Self-Management",
      description:
        "Equip patients to manage symptoms, meds, and activity levels",
      icon: <FaRegChartBar className="w-7 h-7" />,
    },
    {
      title: "Balance & Gait Training",
      description:
        "Improve mobility and lower fall risk through targeted rehab",
      icon: <FaRegChartBar className="w-7 h-7" />,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes. Our sessions are age-appropriate, low-impact, and closely monitored.",
    },
    {
      question: "How soon after a cardiac event can I start rehab?",
      answer:
        "Typically within 1–2 weeks, but it depends on your doctor’s clearance and stability.",
    },
    {
      question: "Will I need equipment at home?",
      answer:
        "Basic items like resistance bands or a stepper may be recommended. We’ll guide you through setup.",
    },
    {
      question: "Can I join if I have both heart and lung issues?",
      answer:
        "Yes, the program is specifically designed to accommodate overlapping conditions safely and effectively.",
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white font-heading leading-tight">
                  Cardio and <span className="text-white/90">Pulmonary</span>{" "}
                  <br />
                  Rehabilitation{" "}
                ...
                <p className="text-white/90 font-body">
                  At Kynexa Advanced Physiotherapy and Manual Therapy Clinic in
                  Delhi, we offer expert Cardio and Pulmonary Rehabilitation to
                  help patients regain strength, improve breathing, and restore
                  independence after heart or lung conditions. Using a tailored,
                  evidence-based approach, we support recovery from cardiac
                  events, COPD, and post-COVID complications. Our compassionate
                  team ensures both physical and emotional care, helping you
                  return to a more active, fulfilling lifestyle.
                </p>
                <p className="text-xl text-white/90 font-body">
                  Breathe Freely. Move Confidently. Live Fully.
                </p>
              </div>
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                  Cardio and Pulmonary Rehabilitation is a medically supervised
                  program that focuses on improving the cardiovascular and
                  respiratory efficiency of patients who have experienced heart
                  or lung-related illness. It blends therapeutic exercise,
                  respiratory training, education, and lifestyle coaching into a
                  holistic recovery plan.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  At Kynexa, we address not only the symptoms but the lifestyle
                  factors that contribute to these conditions, empowering
                  patients to achieve sustainable recovery. We help our clients
                  restore lung capacity, regulate heart function, and improve
                  their ability to perform everyday tasks—safely and
                  confidently.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-6xl mx-auto">
              Our cardio-pulmonary rehab program begins with a comprehensive
              assessment of cardiovascular function, lung capacity, oxygen
              saturation, mobility, and lifestyle risks. Based on your health
              status and goals, our physiotherapists curate a progressive care
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            ...
            <p className="text-lg text-gray-700 font-body">
              We collaborate with physicians and pulmonologists for an
              integrated, informed approach to your care.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="space-y-6 p-6 lg:p-0 order-2 lg:order-1">
              <h2 className="text-3xl sm:text-4xl font-bold text-[#6c2c8b] font-heading">
                Benefits of Cardio and Pulmonary Rehabilitation
              </h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2">
              <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                We understand that recovery from cardiac and respiratory
                conditions is not just about healing the body—it’s about
                regaining independence, restoring confidence, and returning to
                the life you love.
              </p>
              <div className="space-y-4">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            <Info className="w-8 h-8 text-[#9d4ed8] mx-auto mb-3" />
            <p className="text-lg text-gray-700 font-body">
              Every session is goal-driven, adapted to how your body is
              responding, and geared toward helping you resume your
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            ...
            <p className="text-lg text-white/80 font-body leading-relaxed">
              If you or a loved one are navigating the challenges of heart or
              lung recovery, let Kynexa’s compassionate team guide your path to
              strength, breath, and wellness.
            </p>
            <p className="text-sm text-white/70 font-body">
              Online consultations available for eligible cases.
            </p>
          </div>

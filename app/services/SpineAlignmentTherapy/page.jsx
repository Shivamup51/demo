...
export default function SpineAlignmentTherapyPage() {
  ...
  const treatmentApproach = [
    ...
    },
    {
      ...
      description:
        "To correct sitting, standing, and sleeping habits that contribute to misalignment",
      icon: <FaUserMd className="w-7 h-7" />,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Not at all. Most techniques are gentle and relieving. Some mild soreness may occur initially as your body adjusts.",
    },
    {
      question: "How many sessions will I need?",
      answer:
        "It depends on your posture and stiffness level. Some feel relief in 2–3 sessions; others benefit from a short course.",
    },
    {
      question: "Can this help with scoliosis or spinal curvature?",
      answer:
        "Yes. While we don’t 'fix' scoliosis, we can reduce compensatory strain and improve function and comfort.",
    },
    {
      question: "Is this suitable for office workers or sedentary individuals?",
      answer:
        "Absolutely. It’s one of the most effective therapies for reversing the effects of prolonged sitting and poor posture.",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="space-y-8">
              <div className="space-y-5 mt-10">
                ...
                <p className="text-xl text-white/90 font-body">
                  Unwind Stiffness. Realign Posture. Reclaim Movement.
                </p>
                <p className="text-lg text-white/80 font-body max-w-lg leading-relaxed">
                  ...
                  offer Spine Alignment Therapy in Delhi to address chronic body
                  stiffness, postural imbalances, and spinal misalignment.
                  Whether you're dealing with tech-neck, lower back tightness,
                  or general muscular rigidity, our expert physiotherapists use
                  hands-on techniques and corrective exercises to restore spinal
                  balance and improve your body’s natural movement patterns.
                  This therapy is ideal for anyone experiencing fatigue, poor
                  posture, or stiffness from prolonged sitting, stress, or
                  injury.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="relative z-10 bg-white rounded-3xl p-6 lg:p-0 shadow-lg">
                <Image
                  src="/spine/Spine Alignment Main.jpg"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative order-2 lg:order-1">
              <div className="relative z-10 bg-white rounded-3xl p-6 lg:p-0 shadow-lg">
                <Image
                  src="/spine/Spine Alignment What.jpg"
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2 lg:pl-8">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                  ...
                  that focuses on correcting postural deviations and restoring
                  the natural curvature of the spine. Misalignment can occur due
                  to sedentary habits, muscular imbalances, injuries, or
                  degenerative changes—leading to stiffness, pain, and reduced
                  mobility.
                </p>
                <p className="text-lg text-gray-700 font-body leading-relaxed">
                  At Kynexa, we assess spinal posture, joint mobility, and
                  muscular tension to identify the root cause of misalignment.
                  Our therapy combines manual adjustments, myofascial release,
                  mobilization, and neuromuscular re-education to realign the
                  spine and reduce compensatory strain across the body.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            ...
            <p className="text-lg text-gray-700 font-body">
              It’s also beneficial for those recovering from spinal injuries or
              looking to prevent long-term postural degeneration.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-gray-700 font-body max-w-8xl mx-auto">
              We begin with a comprehensive spinal and postural assessment,
              including visual analysis, palpation, and mobility testing. Based
              on your findings, we create a personalized treatment plan that may
              include:
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="space-y-6 p-6 lg:p-0 order-2 lg:order-1">
              <h2 className="text-3xl sm:text-4xl font-bold text-[#6c2c8b] font-heading">
                Benefits of Spine Alignment Therapy
              </h2>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative z-10 bg-white rounded-3xl p-6 lg:p-0 shadow-lg">
                <Image
                  src="/spine/Spine Alignment Benefits.jpg"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative order-2 lg:order-1">
              <div className="relative z-10 bg-white rounded-3xl p-6 lg:p-0 shadow-lg">
                <Image
                  src="/spine/Spine Alignment Why.jpg"
            ...
            <div className="space-y-6 p-6 lg:p-0 order-1 lg:order-2">
              <p className="text-lg text-gray-700 font-body leading-relaxed mb-6">
                We don’t just treat stiffness—we help you move with ease, stand
                tall, and feel aligned from the inside out.
              </p>
              <div className="space-y-4">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-8 bg-slate-50 p-6 rounded-xl shadow-sm">
            <Info className="w-8 h-8 text-[#9d4ed8] mx-auto mb-3" />
            <p className="text-lg text-gray-700 font-body">
              You’ll leave each session feeling lighter, more mobile, and more
              in tune with your body’s alignment.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4 mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold text-white font-heading">
              Book Your Spine Alignment Session Today
            </h2>
            <p className="text-lg text-white/80 font-body leading-relaxed">
              If you’re tired of stiffness, slouching, or spinal discomfort, let
              Kynexa’s expert team help you realign and recharge—naturally and
              effectively.
            </p>
            <p className="text-lg text-white/80 font-body leading-relaxed">

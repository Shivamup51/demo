  ...
  const allServices = [
    {
      ...
      icon: <Syringe className="w-4 h-4 mr-2 text-[#6c2c8b]" />,
    },
    {
      name: "Cupping Therapy",
      href: "/services/cupping-therapy",
      icon: <Waves className="w-4 h-4 mr-2 text-[#6c2c8b]" />,
    },
    {
      name: "Kinesio Taping",
      href: "/services/KinesioTapingTherapy",
      icon: <Bandage className="w-4 h-4 mr-2 text-[#6c2c8b]" />,
    },
    {
      name: "Laser Therapy",
      href: "/services/LaserTherapy",
      icon: <Zap className="w-4 h-4 mr-2 text-[#6c2c8b]" />,
    },
    {
      name: "Manual Therapy",
      href: "/services/ManualTherapy",
      icon: <Activity className="w-4 h-4 mr-2 text-[#6c2c8b]" />,
    },
    {
      name: "Electrotherapy",
    ...
    },
    {
      ...
      icon: <Dumbbell className="w-4 h-4 mr-2 text-[#6c2c8b]" />,
    },
    {
      name: "Cardio & Pulmonary Rehab",
      href: "/services/CardioPulmonaryRehab",
      icon: <Heart className="w-4 h-4 mr-2 text-[#6c2c8b]" />,
    },
    {
      name: "Chiropractic Care",
      href: "/services/ChiropracticCare",
      icon: <Bone className="w-4 h-4 mr-2 text-[#6c2c8b]" />,
    },
    {
      name: "Geriatric Rehabilitation",
      href: "/services/GeriatricRehabilitation",
      icon: <Accessibility className="w-4 h-4 mr-2 text-[#6c2c8b]" />,
    },
    {
    ...
    },
    {
      ...
      icon: <Brain className="w-4 h-4 mr-2 text-[#6c2c8b]" />,
    },
    {
      name: "Pre & Post Natal Physiotherapy",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex justify-between items-center h-20 w-full">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Button
              variant="outline"
              className="border-[#6c2c8b] text-[#6c2c8b] hover:bg-gradient-to-r from-[#6c2c8b] to-[#9d4ed8] hover:text-white rounded-lg transition-colors px-3 py-2 sm:px-4 sm:py-2.5 text-sm sm:text-base"
              asChild
            >
          ...
          <div className="lg:hidden">
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
              ...
              <SheetContent
                side="left"
                className="w-[90vw] max-w-[360px] p-0 flex flex-col"
              >
                ...
                <ScrollArea className="flex-1">
                  <div className="px-4 py-4 space-y-2">
                    ...
                    <div className="pt-6 flex flex-col gap-3">
                      <Button
                        variant="outline"
                        className="w-full border-[#6c2c8b] text-[#6c2c8b] hover:bg-[#6c2c8b]/5 rounded-lg text-sm py-2.5"
                        asChild
                      >
                        <a
                          href="tel:+918868879387"
                          aria-label="Call +91 8868879387"
                        >
                          <PhoneCall className="w-4 h-4 mr-2" />
                          +91 8868879387
                        </a>
